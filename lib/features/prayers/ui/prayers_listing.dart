...
class PrayersScreen extends StatefulWidget {
  ...
  PrayersScreen({this.tabController});

  @override
  _PrayersScreenState createState() => _PrayersScreenState();
}

class _PrayersScreenState
    extends State<PrayersScreen> /* with AutomaticKeepAliveClientMixin*/ {
  //Props
                        ...
                        Expanded(
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: Text("Make anonymous")),
                            ],
                          ),
                        ),
              ...
              ? [
                  ...
                  InkWell (
                    child:Padding(
                      ...
                      child: Image.asset(AssetStrings.dollar,height: 30,width:30,),
                    ),
                    onTap:  () {
...
//                        })
  ...
  //fetch prayers
  getPrayers() {
    _prayerBloc.add(FetchPrayers(currentPage: currentPage));
  }
